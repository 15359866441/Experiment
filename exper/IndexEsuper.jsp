...
<nav>
  <div class="nav">
    ...
    <div>
      ...
      <a href="orders.jsp" target="_blank" id="order">订单</a>
      <a href="backstageMan.jsp" id="backstage" target="_blank">后台管理</a>
    </div>
  </div>
...
<ul class="layui-nav layui-bg-blue">
  <li class="layui-nav-item">
    ...
    <dl class="layui-nav-child">
      <dd><a href="commodity.jsp?pointname=数学">数学</a></dd>
      <dd><a href="javascript:;">物理</a></dd>
      <dd><a href="javascript:;">化学</a></dd>
      <dd><a href="javascript:;">生物科学</a></dd>
    </dl>
  </li>
  <li class="layui-nav-item">
    <a href="javascript:;">工科</a>
    <dl class="layui-nav-child">
      <dd><a href="commodity.jsp?pointname=计算机">计算机</a></dd>
      <dd><a href="javascript:;">信息技术</a></dd>
      <dd><a href="javascript:;">土建</a></dd>
      <dd><a href="javascript:;">机械</a></dd>
    </dl>
  </li>
  <li class="layui-nav-item">
    <a href="javascript:;">农学</a>
    <dl class="layui-nav-child">
      <dd><a href="javascript:;">环境生态</a></dd>
      <dd><a href="javascript:;">水产</a></dd>
  ...
  <li class="layui-nav-item">
    ...
    <dl class="layui-nav-child">
      ...
      <dd><a href="javascript:;">外语</a></dd>
      <dd><a href="commodity.jsp?pointname=法学">法学</a></dd>
  ...
  <li class="layui-nav-item">
    ...
    <dl class="layui-nav-child">
      <dd><a href="javascript:;">其他1</a></dd>
      <dd><a href="javascript:;">其他2</a></dd>
      <dd><a href="javascript:;">其他3</a></dd>
    </dl>
  </li>
  <li class="layui-nav-item">
    <a href="javascript:;">其他</a>
    ...
    <div class="layui-tab-content">
      ...
      <div class="layui-tab-item">
        <form action="ReserveServlet">
          <div>请先预登记信息</div>
          <div>姓&#x3000;&#x3000;名：<input type="text" name="username" style="width: 60px;"></div>
          <div>联系方式：<input type="text" name="calln" style="width: 100px;"></div>
          <div>回收书目：<input type="text" name="bookname" style="width: 100px;"></div>
          <div>数&#x3000;&#x3000;量：<input type="number" name="quantity" style="width: 30px;" value="1"></div>
          <div>备&#x3000;&#x3000;注：<textarea style="vertical-align: top;" name="remark"  cols="15" rows="2"></textarea>
          </div>
          <button type="submit" value="提交" style="display: block; margin: 8px auto 0;
           width: 55px; height: 25px;" onclick="sub()">
          提交</button>
        </form>
        <%-- 由于form提交后会刷新页面，因此可以用一个折中的办法，给form指定一个iframe（内联框架），这样表单提交后
        刷新的就是指定的iframe 而不是页面，通过添加target=“fraSubmit”可实现无刷新提交表单--%>
...
<aside>
  <div class="aside_area">
    ...
    <div>
      <a href=""><img src="images/举报.png" alt=""></a>
      <a href="">举报</a>
    </div>
    <div>
